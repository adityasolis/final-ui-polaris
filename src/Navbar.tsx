...
const Navbar = () => {
  ...
  return (
    <div>
      ...
      {/* Mobile Menu */}
      <div
        className={`fixed top-0 right-0 h-full w-full bg-white shadow-1xl transform transition-transform duration-300 ease-in-out z-40 ${isMenuOpen ? 'translate-x-0' : 'translate-x-full'}`}
      >
        <div className="flex flex-col justify-center h-full space-y-0 md:space-y-0 lg:space-y-0">
          <Link to="/">
